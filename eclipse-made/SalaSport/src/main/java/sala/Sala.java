    ...
    public void forgotUserPass(String eMail,String passW) throws SQLException,Exception{
      ...
      if(con!=null){
          try{
              ...
              rs=stmt.executeQuery(querryString); // asta e aici pt a ne da un SQLException in caz ca nu exista eMailul asta e un workaround
              //pana fac un fel de a ne afisa ca emailul nu exista
              newPass(eMail,passW);
