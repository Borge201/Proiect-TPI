...
public class Sala implements Serializable {
    ...
    public ResultSet vedeTabela(String tabel) throws SQLException, Exception {
    	ResultSet rs=null;
    	try {
    		String queryString=("select * from `Sali_Sport`.`"+ tabel + "`;");
    ...
    public ResultSet vedeAbonamente() throws SQLException, Exception {
    	ResultSet rs = null;
    	try {
    		String queryString = ("select a.emailClienti,b.idAbonamente, b.idClient, b.expDate , b.intrare ,b.Antrenor from Clienti a, Abonamente b where a.idClienti=b.idClient;");
    		Statement stmt = con.createStatement(/*ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY*/);
    		rs = stmt.executeQuery(queryString);
    	} catch (SQLException sqle) {
    		error = "SQLException: Interogarea nu a fost posibila.";
